...
for x in follow_loop:
    elements=driver.find_element_by_xpath("//div[text()='Top 250 Sativa Flower']//following::div[@class='row lmn-top-list-row align-items-center']["+str(x)+"]//div[@class='bg-logo']")
