...
for x in follow_loop:
    elements=driver.find_element_by_xpath("//div[text()='Top 250 Indica Joints']//following::div[@class='row lmn-top-list-row align-items-center']["+str(x)+"]//div[@class='bg-logo']")
